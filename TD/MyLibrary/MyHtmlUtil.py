...
def writeHtmlZKSheetWithInnerHtml(stage_text, prod_text,file_dir,sort_by):
	reload(sys)
	sys.setdefaultencoding( "utf-8" )
	dir= file_dir.replace("/", " ")
	if(sort_by=="H"):
	...
	if(sort_by=="V"):
		sort_css="page_vertical.css"
	html_head= "<!DOCTYPE html>\n <html>\n<head>\n<meta charset=\'utf-8\' />\n <title>WS Compare Result</title>\n<script type=\"text/javascript\" src=\"./js/jquery-1.11.3.js\"></script>\n<style>\n@import url(\'./css/"+sort_css+"\');\n@import url(\'./css/stylesheet_1.css\');\n@import url(\'./css/stylesheet_2.css\');\n</style>\n<script  src = \'./js/CompareZKHTML.js\'>\n</script>\n</head>\n<body onload=\'initCompare()\'>\n"
	html_file = open(dir,"w")
	html_file.write(html_head)		
	if(stage_text):
		html_file.write("<div id='stage'>\n<big>Stage:</big>\n")
